    ...
    public String ToBase58()
    {
        ...
        unsafe
        {
            ...
            fixed (char* alphabetPtr = Base58._alphabet)
            {
                ...
                *outputPtr = alphabetPtr[r0];
                *(outputPtr + 1) = alphabetPtr[r1];
                *(outputPtr + 2) = alphabetPtr[r2];
                *(outputPtr + 3) = alphabetPtr[r3];
                *(outputPtr + 4) = alphabetPtr[r4];
                *(outputPtr + 5) = alphabetPtr[r5];
                *(outputPtr + 6) = alphabetPtr[r6];
                *(outputPtr + 7) = alphabetPtr[r7];
                *(outputPtr + 8) = alphabetPtr[r8];
                *(outputPtr + 9) = alphabetPtr[r9];
                *(outputPtr + 10) = alphabetPtr[r10];
                *(outputPtr + 11) = alphabetPtr[r11];
                *(outputPtr + 12) = alphabetPtr[r12];
                *(outputPtr + 13) = alphabetPtr[r13];
                *(outputPtr + 14) = alphabetPtr[r14];
                *(outputPtr + 15) = alphabetPtr[r15];
                *(outputPtr + 16) = alphabetPtr[r16];
            }
        }
